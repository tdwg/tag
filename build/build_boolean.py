...
# Modified for booleans vocabulary 2024-03-12 by Steve Baskauf
...
headerFileName = 'tag_doc_boolean/termlist-header.md'
footerFileName = 'termlist-footer.md'
outFileName = '../docs/boolean/index.md'
...
config_file_path = 'process/document_metadata_processing/tag_doc_boolean/'
...
# 2021-08-06 Add code to convert backticks to code tags copied from the DwC QRG build script written by S. Van Hoey
