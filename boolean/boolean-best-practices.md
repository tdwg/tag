...
This document describes how the concepts of the [TDWG Boolean Controlled Vocabulary](http://rs.tdwg.org/dwc/doc/boolean/) can be represented in various serializations.  
